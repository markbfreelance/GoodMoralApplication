<x-app-layout>
  ...
  <div x-data="{ sidebarOpen: false }" class="flex min-h-screen">
    ...
    <main class="flex-1 p-6 bg-gray-100 min-h-screen">
      ...
      <!-- Search Form -->
      <form method="GET" action="{{ route('violationsearch') }}" class="mb-4 p-4 bg-white shadow-md rounded-lg">
          ...
          <table class="min-w-full bg-white border border-gray-200 shadow-md rounded-lg">
            ...
            <tbody>
              ...
              <tr class="border-b hover:bg-gray-100">
                <td class="py-3 px-6">{{ $student->ref_num }}</td>
                ...
                <td class="py-3 px-6">
                  ...
                  <div class="space-y-1">
                    ...
                    @if (!$student->downloaded)
                    <form method="POST" action="{{ route('violations.markDownloaded', $student->id) }}">
                      @csrf
