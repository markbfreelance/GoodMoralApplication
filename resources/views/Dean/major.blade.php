<x-app-layout>
  ...
  <div x-data="{ sidebarOpen: false }" class="flex min-h-screen">
    ...
    <main class="flex-1 p-6 bg-gray-100 min-h-screen">
      ...
      <!-- Search Form -->
      <form method="GET" action="{{ route('DeanMajorSearch') }}" class="mb-4 p-4 bg-white shadow-md rounded-lg">
        ...
        <a href="{{ route('dean.major') }}" class="mt-4 inline-block bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700">Clear</a>
