...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-64'"
  ...
  <a href="{{ route('dean.dashboard') }}"
      class="gap-2 h-20 items-center flex px-4 py-2 {{ request()->routeIs('dean.dashboard') ? 'bg-gray-700 text-white' : 'text-gray-700 hover:bg-gray-700 hover:text-gray-300' }}">
